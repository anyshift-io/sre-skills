...
[`iam-policy-auditor`](./skills/iam-policy-auditor/) is built out (11 worked examples, fixture-based replay tests, a committed ablation eval harness); the rest are *planned*. [`incident-investigator`](./skills/incident-investigator/) stays as the reference template: it shows the directory shape, the worked-example format, and the fixture-based replay tests every skill above follows.
